...
fn = {}
  ...
  fn.writeCalendar =  function (req, res, next) {
    ...
    var sql_insert = 'INSERT INTO customer_schedule (_id, name, title, contents, date, percent, time, place, public, notice, member, color) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)' ;
    params = [req.body._id, req.body.name, req.body.title, req.body.contents, req.body.date, req.body.percent ,req.body.time, req.body.place, req.body.public, req.body.notice, req.body.member, req.body.color ];
